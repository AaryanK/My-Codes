...
BIRD_IMGS = [pygame.transform.scale2x(pygame.image.load(os.path.join('images','imgs','bird1.png'))),pygame.transform.scale2x(pygame.image.load(os.path.join('images','imgs','bird2.png'))),pygame.transform.scale2x(pygame.image.load(os.path.join('images','imgs','bird3.png')))]
