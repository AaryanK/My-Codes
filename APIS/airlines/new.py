...
def fetch_buddha_air(dd,mm,yy,fromsector,tosector):
    try:
        json = a['BuddhaAir'].search_flights(dd,mm,yy,fromsector,tosector)
        json["status"] = "success"
        return json
    except:
        return {}
...
def fetch_shree_air(dd,mm,yy,fromsector,tosector):
    try:
        json = a['ShreeAir'].search_flights(dd,mm,yy,fromsector,tosector)
        json["status"] = "success"
        return json
    except:
        return {}
...
def fetch_yeti_airlines(dd,mm,yy,fromsector,tosector,passenger_count=1):
    try:
        json = a['YetiAir'].search_flights(dd,mm,yy,fromsector,tosector,passenger_count)
        json["status"] = "success"
        return json
    except:
        return {}
...
def fetch_saurya_airlines(dd,mm,yy,fromsector,tosector,passenger_count=1):
    try:
        json = a['SauryaAir'].search_flights(dd,mm,yy,fromsector,tosector,passenger_count)
        json["status"] = "success"
        return json
    except:
        return {}
...
def fetch_guna_airlines(dd,mm,yy,fromsector,tosector,passenger_count=1):
    try:
        json = a['GunaAir'].search_flights(dd,mm,yy,fromsector,tosector,passenger_count)
        json["status"] = "success"
        return json
    except:
        return {}
